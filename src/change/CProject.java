...
public class CProject implements Serializable {
	...
	public static int[] densityBins = {2, 4, 8, 16, 32, 64, 128, Integer.MAX_VALUE};
	...
	static {
		...
		for (byte id : interestingAstNodeTypeIds) {
			interestingAstNodeTypeNames.add(ASTNode.nodeClassForType(id).getSimpleName());
		}
	}
	...
	private List<HashMap<Integer, List<CTokenSequence>>> cTrees;
	private HashMap<CTokenSequence, HashMap<CTokenSequence, TokenSequenceChange>> changes;
	...
	public CProject(String path, int id, String name) {
		...
		this.cTrees = (List<HashMap<Integer, List<CTokenSequence>>>) FileIO.readObjectFromFile(prefix + "trees.dat");
		this.changes = (HashMap<CTokenSequence, HashMap<CTokenSequence, TokenSequenceChange>>) FileIO.readObjectFromFile(prefix + "changes.dat");
	}
	...
	public List<HashMap<Integer, List<CTokenSequence>>> getcTrees() {
		return cTrees;
	}
	public void setcTrees(List<HashMap<Integer, List<CTokenSequence>>> cTrees) {
		this.cTrees = cTrees;
	}
	public HashMap<CTokenSequence, HashMap<CTokenSequence, TokenSequenceChange>> getChanges() {
		return changes;
	}
	public void setChanges(
			HashMap<CTokenSequence, HashMap<CTokenSequence, TokenSequenceChange>> changes) {
