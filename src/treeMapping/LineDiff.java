...
public class LineDiff {
	...
	private int numOfLOCsM = 0, numOfNonCommentLOCsM = 0, numOfChangeLOCsM = 0, numOfLOCsN = 0, numOfNonCommentLOCsN = 0, numOfChangeLOCsN = 0;
	...
	public int getNumOfLOCsM() {
		return numOfLOCsM;
	}

	public int getNumOfNonCommentLOCsM() {
		return numOfNonCommentLOCsM;
	}

	public int getNumOfChangeLOCsM() {
		return numOfChangeLOCsM;
	}
	
	public int getNumOfLOCsN() {
		return numOfLOCsN;
	}

	public int getNumOfNonCommentLOCsN() {
		return numOfNonCommentLOCsN;
	}

	public int getNumOfChangeLOCsN() {
		return numOfChangeLOCsN;
	}
	...
	public ArrayList<ArrayList<Integer>> doDiff()
	{
		...
		this.numOfLOCsM = lines1.size();
		this.numOfNonCommentLOCsM = nonblankLines1.size();
		this.numOfChangeLOCsM = this.numOfNonCommentLOCsM - lcsM.size();
		this.numOfLOCsN = lines2.size();
		this.numOfNonCommentLOCsN = nonblankLines2.size();
		this.numOfChangeLOCsN = this.numOfNonCommentLOCsN - lcsN.size();
